  ...
  <div class="row">
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   <div class="panel-heading"><?php echo e(trans('message.addmainskills')); ?> </div>
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'store','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>
							 ...
							 <div class="form-body pal">
								 <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
								   ...
								   <div class="col-md-9">
									  ...
									  <?php echo e(Form::text('name', '', array('class' => 'form-control','placeholder'=> trans('message.mainskillname'),'required'=>true))); ?>
								...
								<div class="form-group <?php echo e($errors->has('grouping_id') ? 'has-error' : ''); ?>">
									...
									<div class="col-md-9">
									 <div class="input-icon">
										 <?php echo Form::select('grouping_id', $groupingArray , null, ['class' => 'form-control']); ?>
