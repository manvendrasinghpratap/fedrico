                  ...
                  <div class="row mbm">
                     <div class="col-lg-12">
                        ...
                        <div class="portlet-header pam mbn">
                           <div class="caption"><?php echo e(trans('message.mainskills')); ?></div>
                           <div class="actions">
                              <a href="<?php echo e(url(key($listing))); ?>" class="btn btn-info btn-sm">
                                 <i class="fa fa-plus"></i>&nbsp;
                                 <?php echo e(trans('message.addmainskills')); ?>
                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              <?php $__currentLoopData = $skillDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="hide_<?php echo e($row->id); ?>">
                                    <td><?php echo e($row->skillname); ?></td>
                                    <td><?php echo e($row->grouping->groupname); ?></td>
                                    <td>
                                       <a class="btn btn-default btn-xs edit" href="<?php echo e(URL::to('editmainskill/'.\App\Helpers\Common::encodeParam($row->id) )); ?>" title="Edit Main Skill"> <i class="fa fa-edit"></i></a>
