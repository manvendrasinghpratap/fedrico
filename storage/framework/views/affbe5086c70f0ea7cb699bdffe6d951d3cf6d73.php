  ...
  <div class="row">
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   <div class="panel-heading"><?php echo e(trans('message.editcourse')); ?></div>
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'updatecourse','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>

						   <?php echo e(Form::hidden('id', $courseDetails['id'], array('name'=>'id'))); ?>
							 ...
							 <div class="form-body pal">
								 <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
								   ...
								   <div class="col-md-9">
									  ...
									  <?php echo e(Form::text('name', $courseDetails['name'], array('class' => 'form-control','placeholder'=>trans('message.coursename'),'required'=>true))); ?>
